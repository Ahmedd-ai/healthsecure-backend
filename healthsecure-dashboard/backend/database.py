...
# Use environment variable for MongoDB connection (for Render deployment)
# For local development, use: mongodb://localhost:27017
# For production (Render), use MongoDB Atlas connection string in RENDER_MONGO_URL env var
MONGO_URL = os.environ.get("RENDER_MONGO_URL", "mongodb://localhost:27017")
