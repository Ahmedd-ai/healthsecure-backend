...
# Add parent directory to path for imports - but append instead of insert at beginning
# to avoid overriding local backend modules
importpath = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
